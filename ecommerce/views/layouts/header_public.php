...
<head>
  ...
  <title><?= isset($title) ? e($title) . ' - ' : '' ?><?= APP_NAME ?> | Tienda Oficial & Servicio Técnico Especializado</title>
  ...
  <div class="cb-topbar-inner">
    <div class="cb-topbar-left">
      <span class="cb-topbar-item highlight">
        ...
        <span>Envíos a todo el Perú & Retiro gratuito en tienda</span>
      </span>
    ...
    <div class="cb-topbar-right">
      <a href="https://wa.me/51975513327?text=Hola%20MAKPC,%20deseo%20asesoria%20tecnica" target="_blank" class="cb-topbar-link">
      ...
      <a href="<?= url('tienda/soporte') ?>" class="cb-topbar-link">
        ...
        <span>Rastrear Orden de Taller</span>
      </a>
    </div>
  </div>
</div>
...
<header class="cb-main-header">
  <div class="cb-header-inner">
    ...
    <a href="<?= url() ?>" class="cb-brand" title="<?= APP_NAME ?> - Inicio">
      <img src="<?= asset('img/logo.png') ?>" alt="Logo MAKPC">
      <div class="cb-brand-text">
        <div class="cb-brand-name">
          MAK<span class="accent">PC</span>
        </div>
        <span class="cb-brand-sub">ENTERPRISES STORE</span>
      </div>
    </a>
...
<div class="public-mobile-drawer" id="publicMobileDrawer">
  <div class="mobile-drawer-header">
    <div class="mobile-drawer-brand">
      <img src="<?= asset('img/logo.png') ?>" alt="Logo MAKPC">
      <span>MAK<span style="color:var(--cb-gold)">PC</span> STORE</span>
    </div>
